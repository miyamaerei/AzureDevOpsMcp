...
This project is indexed by GitNexus as **AzureDevOpsMcp** (2083 symbols, 4444 relationships, 155 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
