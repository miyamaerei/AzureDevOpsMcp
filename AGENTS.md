...
This project is indexed by GitNexus as **AzureDevOpsMcp** (2088 symbols, 4613 relationships, 174 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
